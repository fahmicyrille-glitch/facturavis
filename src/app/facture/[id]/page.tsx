              ...
              {rating === 5 && hasValidGoogleLink ? (
                <div className="py-8 animate-in zoom-in duration-300">
                  ...
                  <a
                    ...
                    className="group w-full inline-flex items-center justify-center gap-3 py-4 px-5 rounded-2xl text-white font-bold text-lg bg-gradient-to-r from-[#4285F4] to-[#5a9bff] shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 mb-3"
                  >
                    <span className="flex items-center justify-center w-7 h-7 bg-white rounded-full shrink-0 shadow-sm">
